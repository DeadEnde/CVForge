...
|---|---|---|
| **Free** | $0 | Local MCP runs, all 11 themes, offline playground |
...
## Where to sell
| Platform | Creator share | Note |
|---|---|---|
| MCPize | 80–85% | Hosted deploy + billing |
| MCP Marketplace | 85% | License keys + Stripe |
| Own site + Stripe | 100% | Once you have traffic |

List free on mcp.so, Smithery, Glama, PulseMCP, Product Hunt.
